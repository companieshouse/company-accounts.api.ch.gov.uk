...
locals {
  ...
  lb_listener_paths          = ["/transactions/*/company-accounts*","/private/transactions/*/company-accounts*","/company-accounts/healthcheck","/transactions/*/company-accounts/*/cic-report*"]
