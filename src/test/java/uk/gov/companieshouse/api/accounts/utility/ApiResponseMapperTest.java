...
public class ApiResponseMapperTest {
    ...
    void canMapCreateResponse() {
        ResponseEntity responseEntity = apiResponseMapper
            .map(ResponseStatus.CREATED, restObject, errors);
    ...
    void canMapConflictResponse() {
        ResponseEntity responseEntity = apiResponseMapper
            .map(ResponseStatus.DUPLICATE_KEY_ERROR, restObject, errors);
        assertNotNull(responseEntity);
    ...
    void canMapDefaultResponse() {
        ResponseEntity responseEntity = apiResponseMapper
            .map(ResponseStatus.NOT_FOUND, restObject, errors);
        assertNotNull(responseEntity);
