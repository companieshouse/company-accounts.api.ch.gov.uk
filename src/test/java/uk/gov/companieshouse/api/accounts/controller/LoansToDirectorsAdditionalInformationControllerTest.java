...
class LoansToDirectorsAdditionalInformationControllerTest {
    ...
    private static final String ADDITIONAL_INFORMATION_ID = "additionalInformationId";
    ...
    @Mock
    private Map<String, String> additionalInformationLink;
    ...
    void createAdditionalInformationResourceSuccess() throws DataException {
        ...
        ResponseEntity returnedResponse =
                additionalInformationController.create(additionalInformation,
    ...
    void updateAdditionalInformationResourceNoAdditionalInformationLink() {
        ...
        ResponseEntity responseEntity =
                additionalInformationController.update(additionalInformation,
                        COMPANY_ACCOUNTS_ID, request);
