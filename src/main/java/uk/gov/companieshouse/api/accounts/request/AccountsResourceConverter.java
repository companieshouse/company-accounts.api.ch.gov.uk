    ...
    public AccountsResource getAccountsResource(AccountType accountType, Resource resource, Period period) {
        ...
        if (period == null) {
            ...
            if (accountsResource == null) {
                throw new InvalidPathParameterException("No AccountsResource found for account type: " + accountType.toString() +
            ...
            if (accountsResource == null) {
                throw new InvalidPathParameterException("No AccountsResource found for account type: " + accountType.toString() +
                        ", resource: " + resource.toString() + " and period: " + period.toString());
            }
            return accountsResource;
        }
    }
