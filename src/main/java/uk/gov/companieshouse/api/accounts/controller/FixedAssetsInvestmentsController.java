...
public class FixedAssetsInvestmentsController {
    ...
    @PostMapping
    public ResponseEntity create(@Valid @RequestBody FixedAssetsInvestments fixedAssetsInvestments,
        ...
        try {
            ResponseObject<FixedAssetsInvestments> response = fixedAssetsInvestmentsService
                    .create(fixedAssetsInvestments, transaction, companyAccountId, request);
    ...
    @PutMapping
    public ResponseEntity update(@RequestBody @Valid FixedAssetsInvestments fixedAssetsInvestments,
                                 BindingResult bindingResult,
                                 @PathVariable("companyAccountId") String companyAccountId,
                                 HttpServletRequest request) {

        SmallFull smallFull = (SmallFull) request.getAttribute(AttributeName.SMALLFULL.getValue());
        if (smallFull.getLinks().get(SmallFullLinkType.FIXED_ASSETS_INVESTMENTS_NOTE.getLink()) == null) {
        ...
        try {
            ResponseObject<FixedAssetsInvestments> response = fixedAssetsInvestmentsService
                .update(fixedAssetsInvestments, transaction, companyAccountId, request);
