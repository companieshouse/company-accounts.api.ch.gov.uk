...
public enum ExceptionMessage {
  NO_HANDLER_FOUND_EXCEPTION("No Handler Found for the requested resouce", "NoHandlerFoundException"),
  ...
  TRANSACTION_STATUS_NOT_OPEN("Cannot Update on a Transaction with Closed status", "Accounts API Error"),
  ...
  ABRIDGED_ACCOUNT_NOT_FOUND("Abridged Account Not Found", "Accounts API Error"),
