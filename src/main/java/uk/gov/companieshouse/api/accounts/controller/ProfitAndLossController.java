...
@RestController
@RequestMapping(value = "/transactions/{transactionId}/company-accounts/{companyAccountId}/small-full/{accountingPeriod}/profit-and-loss", produces = MediaType.APPLICATION_JSON_VALUE)
